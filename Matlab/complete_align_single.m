...
if(iteration==4||iteration==5)
    ...
    if(hi_rng<.001) %CHANGE THIS VALUE ACCORDING TO PRECISION REQUIREMENTS
        ...
        line6 = cellstr(['\indent...after ' variableList{4} ' intensity scans.\\']);
        line7 = cellstr(['\indent...with ' variableList{5} ' measurements taken at each distance.\\']);
        line8 = cellstr(['\indent...with data from ' variableList{6} ' distances.\\']);
        %change this
        line9 = cellstr(['\includegraphics[height=.5\textheight, trim={4cm 8.5cm 4cm 8.5cm},clip]{' variableList{7} '}\\']);
