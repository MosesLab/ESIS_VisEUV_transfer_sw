...
\begin{figure}[H]
\centering
\includegraphics[height=.5\textheight, trim={4cm 8.5cm 4cm 8.5cm},clip]{/home/krg/ESIS_VisEUV_transfer_sw/Output/VIS/grating_1/20170814-144648/iterations/iteration_3/all_fig_combo.pdf}\\
\end{figure}
\end{document}
