...
\indent...for channel 1 lies at 8.4744 mm to a precision of 121.92 microns with a target of 15.3 micron.\\
...
\begin{figure}[H]
\centering
\includegraphics[height=.5\textheight, trim={4cm 8.5cm 4cm 8.5cm},clip]{/home/krg/ESIS_VisEUV_transfer_sw/Output/VIS/grating_1/20170815-134734/iterations/iteration_3/all_fig_combo.pdf}\\
\end{figure}
\end{document}
